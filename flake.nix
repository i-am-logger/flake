{
  ...
  inputs = {
    ...
    nixpkgs.url = "/home/snick/Code/nix/nixpkgs";
    ...
    # url = "/home/snick/Code/github/snick/xdg-desktop-portal-hyprland";
    # inputs.nixpkgs.follows = "nixpkgs";
    # };
  ...
  in {
    ...
    nixosConfigurations = {
      handlink = lib.nixosSystem {
        specialArgs = {inherit pkgs disko self inputs username;}; #hyprland
        modules = [
          ({modulesPath, ...}: {
            imports = [
